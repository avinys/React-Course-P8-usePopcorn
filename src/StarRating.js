...
StarRating.propTypes = {
    maxRating: PropTypes.number, //PropTypes.number.isRequired if an attributeis required
...
export function StarRating({
    ...
    const [rating, setRating] = useState(defaultRating >= 0 && defaultRating <= maxRating ? defaultRating : 0);
    ...
    const textStyle = { lineHeight: "1", margin: "0", fontSize: `${size}px`, color: color };
...
function Star({ onClick, isFull, onHoverIn, onHoverOut, color, size }) {
